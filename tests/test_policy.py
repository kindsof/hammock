...
class TestPolicy(unittest.TestCase):
    ...
    def test_policy(self):
        policy = _policy.Policy(POLICY_FILE, credentials_class=tests_base.TestCredentials)
        self._test_policy(
            policy,
            'project-admin', True,
            {'project_id': 'project-id-1'},
            {tests_base.HEADER_ROLES: 'project_admin', tests_base.HEADER_PROJECT_ID: 'project-id-1'}
        )
        self._test_policy(
            policy,
            'project-admin', True,
            {'project_id': 'project-id-2'},
            {tests_base.HEADER_ROLES: 'admin', tests_base.HEADER_PROJECT_ID: 'project-id-1'}
        )
        self._test_policy(
            policy,
            'project-admin', False,
        ...
        self._test_policy(policy, 'user-moshe-reference', True, {}, {tests_base.HEADER_USER_NAME: 'moshe'})
        self._test_policy(policy, 'user-moshe-reference', False, {}, {tests_base.HEADER_USER_NAME: 'haim'})
    ...
    def test_add_rule(self):
        ...
        self._test_policy(policy, 'user-moshe', True, {}, {tests_base.HEADER_USER_NAME: 'moshe'})
        self._test_policy(policy, 'user-haim', False, {}, {tests_base.HEADER_USER_NAME: 'haim'})

        policy.set({'user-haim': 'user_name:haim'})

        self._test_policy(policy, 'user-moshe', True, {}, {tests_base.HEADER_USER_NAME: 'moshe'})
        self._test_policy(policy, 'user-haim', True, {}, {tests_base.HEADER_USER_NAME: 'haim'})

    def test_override_rule(self):
        policy = _policy.Policy(POLICY_FILE, credentials_class=tests_base.TestCredentials)

        self._test_policy(policy, 'user-moshe', True, {}, {tests_base.HEADER_USER_NAME: 'moshe'})
        self._test_policy(policy, 'user-moshe', False, {}, {tests_base.HEADER_USER_NAME: 'haim'})

        policy.set({'user-moshe': 'user_name:haim'})

        self._test_policy(policy, 'user-moshe', False, {}, {tests_base.HEADER_USER_NAME: 'moshe'})
        self._test_policy(policy, 'user-moshe', True, {}, {tests_base.HEADER_USER_NAME: 'haim'})
